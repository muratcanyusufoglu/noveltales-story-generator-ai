...
const relativeDimensionTo = isWeb ? "window" : "screen", SheetImplementationCustom = React.forwardRef(
  function(props, forwardedRef) {
    ...
    let contents = /* @__PURE__ */ jsx(ParentSheetContext.Provider, { value: nextParentContext, children: /* @__PURE__ */ jsxs(SheetProvider, { ...providerProps, children: [
    ...
    if (!USE_NATIVE_PORTAL) {
      ...
      contents = /* @__PURE__ */ jsx(ProvideAdaptContext, { ...adaptContext, children: contents });
    }

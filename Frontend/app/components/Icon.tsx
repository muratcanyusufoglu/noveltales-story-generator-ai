...
export const iconRegistry = {
  ...
  createBook: require("../../assets/icons/createBook.png"),
  discoverBook: require("../../assets/icons/discoverBook.png"),
  home: require("../../assets/icons/home.png"),
  myStories: require("../../assets/icons/myStories.png"),
  edit: require("../../assets/icons/edit.png"),
  crown: require("../../assets/icons/crown.png"),
  crownPremium: require("../../assets/icons/crownPremium.png"),
